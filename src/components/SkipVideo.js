...
function SkipVideo({skipVideo, onClick}) {
    return (
        <span className="skip-song-button action-button" onClick={onClick}>
            <svg height="800px" width="800px" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg"
                 viewBox="0 0 22.257 22.257">
<g>
	<g id="c95_rewind">
		<path style={skipVideo ? {"fill": "gold"} : {"fill": "white"}} d="M9.109,2.27c0.139-0.072,0.303-0.051,0.426,0.043l10.775,8.503
		...
		<path style={skipVideo ? {"fill": "gold"} : {"fill": "white"}} d="M0.221,2.27c0.141-0.072,0.307-0.051,0.424,0.043l10.777,8.503
		...
		<path style={skipVideo ? {"fill": "gold"} : {"fill": "white"}} d="M19.287,2.26h2.656c0.174,0,0.314,0.183,0.314,0.4v16.935c0,0.222-0.141,0.404-0.314,0.404h-2.656
